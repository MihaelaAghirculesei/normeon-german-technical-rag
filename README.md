...
Status: Day 8 of 30. Backend skeleton, DB schema + migrations, structured
...
normalisation and a trigram fallback, and hybrid retrieval fusing the
three branches with Reciprocal Rank Fusion.
